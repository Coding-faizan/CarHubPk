        ...
        <View style={styles.container}>
          <View style={styles.filtersContainer}>
            ...
            <View style={styles.sliderContainer}>
              <Text style={styles.sliderText}>{`Min: ${formatPrice(
                filters.priceMin
              )}`}</Text>
              <MultiSlider
              ...
              />
              <Text style={styles.sliderText}>{`Max: ${formatPrice(
                filters.priceMax
              )}`}</Text>
            </View>
            ...
            <View style={styles.sliderContainer}>
              ...
              >{`Min: ${filters.engineCapacityMin}`}</Text>
              <MultiSlider
                values={[
                  filters.engineCapacityMin,
                  filters.engineCapacityMax === 2000
                    ? 1999
                    : filters.engineCapacityMax,
                ]}
                min={400}
                max={2000}
                step={1}
                ...
                onValuesChange={(values) =>
                  handleInputChange("engineCapacityMin", values[0])
                }
                onValuesChangeFinish={(values) =>
                  setFilters((prevState) => ({
                    ...prevState,
                    engineCapacityMax: values[1],
                  }))
                }
                allowOverlap={false}
                snapped
                ...
                containerStyle={{ height: 40 }}
              />
              <Text style={styles.sliderText}>{`Max: ${
                filters.engineCapacityMax === 2000
                  ? "Any"
                  : filters.engineCapacityMax
              }`}</Text>
            ...
            <View style={styles.tabsContainer}>
              <TouchableOpacity
                style={[
                  styles.tabButton,
                  filters.condition === "Both" && styles.selectedTab,
                ]}
              ...
              <TouchableOpacity
                style={[
                  styles.tabButton,
                  filters.condition === "Used" && styles.selectedTab,
                ]}
              ...
              <TouchableOpacity
                style={[
                  styles.tabButton,
                  filters.condition === "New" && styles.selectedTab,
                ]}
          ...
          <View style={styles.tabsContainer}>
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.transmission === "Automatic" && styles.selectedTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.transmission === "Manual" && styles.selectedTab,
              ]}
          ...
          <View style={styles.tabsContainer}>
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.fuelType === "Petrol" && styles.selectedTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.fuelType === "Diesel" && styles.selectedTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.fuelType === "CNG" && styles.selectedTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.fuelType === "Hybrid" && styles.selectedTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.fuelType === "Electric" && styles.selectedTab,
              ]}
          ...
          <View style={styles.tabsContainer}>
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.variant === "Sedan" && styles.selectedTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.variant === "Hatchback" && styles.selectedTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.variant === "SUV" && styles.selectedTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.variant === "MPV" && styles.selectedTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.variant === "Offroad" && styles.selectedTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.variant === "Mini" && styles.selectedTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.variant === "Truck" && styles.selectedTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.variant === "Sports" && styles.selectedTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.tabButton,
                filters.variant === "High Roof" && styles.selectedTab,
              ]}
          ...
          <View style={styles.tabsContainer}>
            <TouchableOpacity
              style={[
                ...
                filters.color === "Red" && styles.selectedColorTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.colorTabButton,
                filters.color === "Blue" && styles.selectedColorTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.colorTabButton,
                filters.color === "Black" && styles.selectedColorTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.colorTabButton,
                filters.color === "White" && styles.selectedColorTab,
              ]}
              onPress={() => handleInputChange("color", "White")}
            >
              <View
                style={[styles.colorCircle, { backgroundColor: "white" }]}
              />
            ...
            <TouchableOpacity
              style={[
                styles.colorTabButton,
                filters.color === "Gray" && styles.selectedColorTab,
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.colorTabButton,
                filters.color === "Silver" && styles.selectedColorTab,
              ]}
              onPress={() => handleInputChange("color", "Silver")}
            >
              <View
                style={[styles.colorCircle, { backgroundColor: "silver" }]}
              />
            ...
            <TouchableOpacity
              style={[
                styles.colorTabButton,
                filters.color === "Green" && styles.selectedColorTab,
              ]}
